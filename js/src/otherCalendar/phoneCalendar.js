...
;(function ($, undefined) {
    ...
    */
    ...
    var PhoneCalendar = function(pObj,pOpts) {
        this.opts = {
            date: new Date(),
            //高亮的日期
            activeDatas:[],
    ...
    PhoneCalendar.prototype = {
        init: function () {
            ...
            if($.type(this.onChangeMonth) == "function"){
                this.onChangeMonth.call(null,_date,this.changeYear,this.changeMonth);
            }
            this.render(_date);
            ...
            this.panel.appendTo(this.container || this.target);
            ...
            //新增高亮显示
            for(var i = 0,l = this.activeDatas.length;i < l;i++){
                if(pData.format("yyyy-mm-dd") == this.activeDatas[i]){
                    returnValue = this.classNames.active;
                }                
            }
            return returnValue;
    ...
    $.fn.extend({
        PhoneCalendar: function (pOpts) {
            var _defaults = {};
            if (typeof pOpts !== "undefined") {
                $.extend(true, _defaults, pOpts);
            }
            PhoneCalendar["instance"] = new PhoneCalendar(this, _defaults);
            return PhoneCalendar["instance"];
        }
    });
})(jQuery, undefined);
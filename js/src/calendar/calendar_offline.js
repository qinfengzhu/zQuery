        ...
        var _defaults = {
            options: {
                ...
                styles: '.calendar_wrap{ width:363px;background: #fff;padding:0px 5px 0;\
                    ...
                    .calendar_month dt{ float: left; width: 24px; height: 22px; line-height: 20px; color: #666; background-color: #ececec; margin-bottom: 2px; }\
                    .calendar_month .weekend{font-weight: bold;color: #f90;}\
                    .calendar_day a{ float: left; width: 22px; height: 24px; line-height: 24px; margin-bottom: 1px; padding-right: 1px; font-size: 11px; font-weight: bold; color: #005ead; background-color: #fff; cursor: pointer; }\
